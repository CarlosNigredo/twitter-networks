d3.json("data/oaxaca_Jun252016_filtro_preprocesado.json", function(data) {
    ...
    nodes.forEach(function(d) {
        if(d.inDegree === 0) {
            ...
            d.radius = Math.pow(d.inDegree, 0.65)*baseRadius;
        }
    });
    ...
    var cambiaTamanio = 0;
    d3.selectAll("#degree input").on("click", function(d){ 
        if(d3.select("#inDegree").property("checked")===true){
            nodes.forEach(function(d) {
                if(d.inDegree === 0) {
                    d.radius = 2.54;
                } else{
        ...
        else if(d3.select("#outDegree").property("checked")===true){
            nodes.forEach(function(d) {
                if(d.outDegree === 0) {
                    d.radius = 2.54;
                } else{
                    d.radius = Math.pow(d.outDegree, 0.65)*baseRadius;
                }
            });
            node.attr("r", function(n) {
                return n.radius;
    ...
    d3.selectAll("#selectorsNodes label").on("mouseup", function(d) {
