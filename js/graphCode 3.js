//AQUÍ VAMOS A ARREGLAR LOS FILTROS POR TIPO DE NODO
d3.json("data/HoyNoCircula/hoy_no_circula_Apr032016_filtro.json", function(data) {
    ...
    // Si eliminamos nodos, este paso debe ser posterior a la eliminación de elementos 
    links.forEach(function(d) {
        d.straight = 1;
    ...
    // console.log("length= " + repliers.length);
